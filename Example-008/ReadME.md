...
<li>the implementations for the <i>custom</i> functions of interest are stored in the <i>'myfunctions.cpp'</i> C++ source file (in the <i>'src'</i> folder)</li></ul><p>Several methods for building this test are provided, and take into the account its source code organization (described above).<p><hr><p>

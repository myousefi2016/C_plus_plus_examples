/**********************************************************************************************
 * Examples in the C++ language (the test 'Example-013')
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), December 2016
 *
 * main.cpp - the source file, implementing the main function for the test 'Example-013'.
 **********************************************************************************************/
...
/// The main function for the <i>Example-013</i> unit test.
int main(void)
{
	/* This is the example 'Example-013', where the properties of the 'bool' type are analyzed. */
    cout<<endl<<"\tThis is the example 'Example-013' in the C++ language"<<endl<<endl;
    cout.flush();
	cout<<"\tThe C++ built-in 'bool' type:"<<endl<<endl;

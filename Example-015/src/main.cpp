/**********************************************************************************************
 * Examples in the C++ language (the test 'Example-015')
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), December 2016
 *
 * main.cpp - the source file, implementing the main function for the test 'Example-015'.
 **********************************************************************************************/
...
/// The main function for the <i>Example-015</i> unit test.
int main(void)
{
	/* This is the example 'Example-015', where the properties of the 'unsigned char' type are analyzed. */
    cout<<endl<<"\tThis is the example 'Example-015' in the C++ language"<<endl<<endl;
    cout.flush();
	cout<<"\tThe C++ built-in 'unsigned char' type:"<<endl<<endl;
	...
	cout<<"\t-) requires "<<std::numeric_limits<unsigned char>::digits<<" digit"<<endl;
	cout<<"\t-) requires "<<std::numeric_limits<unsigned char>::digits10<<" base-10 digit"<<endl;

/**************************************************************************************************
 * Examples in the C++ language (the 'Example-018' unit test).
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), March 2017
 *
 * main.cpp - the source file, implementing the main function for the 'Example-018' unit test.
 **************************************************************************************************/
...
int main(void)
{
	/* This is the 'Example-018' unit test, where the properties of the 'integer (int)' C++ built-in type are analyzed. */
    cout<<endl<<"\tThis is the 'Example-018' unit test in the C++ language."<<endl<<endl;
    cout.flush();
    
    /* TASK #1 - retrieving the properties of the 'integer (int)' C++ built-in type. */
	cout<<"\tThe 'integer (int)' C++ built-in type:"<<endl<<endl;
	...
	cout<<"\t-) has "<<(int)std::numeric_limits<int>::epsilon()<<" as the machine epsilon, that is, the difference between 1.0 and the next value, representable as an 'int' value;"<<endl;

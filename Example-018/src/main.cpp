 ...
 *
 * main.cpp - the source file, implementing the main function for the 'Example-018' Test.
 **************************************************************************************************/
...
int main(void)
{
	/* This is the 'Example-018' Test, where the properties of the 'integer (int)' C++ built-in type are analyzed. */
    cout<<endl<<"\tThis is the 'Example-018' Test in the C++ language."<<endl<<endl;
    cout.flush();

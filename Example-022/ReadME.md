...
This basic example about the use of the C++ programming language exploits the '<i>std::numeric_limits</i>' template class (defined in the <i>'< limits >'</i> header file) for analyzing several properties of the <i>'long integer (long)'</i> C++ built-in type. Also the new capabilities of this template class, introduced by the C++11 standard, are evaluated and exploited.

 ...
 *
 * main.cpp - the source file, implementing the main function for the 'Example-022' Test.
 **************************************************************************************************/
...
int main(void)
{
	/* This is the 'Example-022' Test, where the properties of the 'long integer (long int)' C++ built-in type are analyzed. */
    cout<<endl<<"\tThis is the 'Example-022' Test in the C++ language."<<endl<<endl;
    cout.flush();

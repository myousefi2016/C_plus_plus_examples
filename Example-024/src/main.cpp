/**********************************************************************************************
 * Examples in the C++ language (the test 'Example-024')
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), December 2016
 *
 * main.cpp - the source file, implementing the main function for the test 'Example-024'.
 **********************************************************************************************/
...
int main(void)
{
	/* This is the example 'Example-024', where the properties of the 'char16_t' type are analyzed. */
    cout<<endl<<"\tThis is the example 'Example-024' in the C++ language"<<endl<<endl;
    cout.flush();
	cout<<"\tThe C++ built-in 'char16_t' type:"<<endl<<endl;

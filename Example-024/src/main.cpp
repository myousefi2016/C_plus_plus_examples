 ...
 *
 * main.cpp - the source file, implementing the main function for the 'Example-024' Test.
 **************************************************************************************************/
...
int main(void)
{
	/* This is the 'Example-024' Test, where the properties of the 'UTF-16 character (char16_t)' C++ built-in type are analyzed. */
    cout<<endl<<"\tThis is the 'Example-024' Test in the C++ language."<<endl<<endl;
    cout.flush();

/**********************************************************************************************
 * Examples in the C++ language (the test 'Example-025')
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), December 2016
 *
 * main.cpp - the source file, implementing the main function for the test 'Example-025'.
 **********************************************************************************************/
...
/// The main function for the <i>Example-025</i> unit test.
int main(void)
{
	/* This is the example 'Example-025', where the properties of the 'char32_t' type are analyzed. */
    cout<<endl<<"\tThis is the example 'Example-025' in the C++ language"<<endl<<endl;
    cout.flush();
	cout<<"\tThe C++ built-in 'char32_t' type:"<<endl<<endl;

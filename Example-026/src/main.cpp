 ...
 *
 * main.cpp - the source file, implementing the main function for the 'Example-026' Test.
 **************************************************************************************************/
...
int main(void)
{
	/* This is the 'Example-026' Test, where the properties of the 'wide character (wchar_t)' C++ built-in type are analyzed. */
    cout<<endl<<"\tThis is the 'Example-026' Test in the C++ language."<<endl<<endl;
    cout.flush();

/**************************************************************************************************
 * Examples in the C++ language (the 'Example-030' Test).
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), May 2017
 *
 * main.cpp - the source file, implementing the main function for the 'Example-030' Test.
 **************************************************************************************************/
...
/// The main function for the <i>'Example-030'</i> Test.
int main(void)
{
	/* This is the 'Example-030' Test, where the properties of the 'long double floating-point (long double)' C++ built-in type are analyzed. */
    cout<<endl<<"\tThis is the 'Example-030' Test in the C++ language."<<endl<<endl;
    cout.flush();

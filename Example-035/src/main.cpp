 ...
 *
 * main.cpp - the source file, implementing the main function for the 'Example-035' unit test.
 **************************************************************************************************/
...
int main(void)
{
	...
	/* This is the 'Example-035' unit test, where the call-by-reference parameters passing for a function is validated. */
    cout<<endl<<"\tThis is the 'Example-035' unit test in the C++ language."<<endl<<endl;
    cout.flush();

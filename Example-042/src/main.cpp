...
int main(void)
{
	...
	if(g1!=g2) cout<<"\tThe internal states of the linear congruential engines 'g1' and 'g2' do not coincide (with respect to the operator '!=')"<<endl;
	else cout<<"\tThe internal states of the linear congruential engines 'g1' and 'g2' coincide (with respect to the operator '!=')"<<endl;
	cout<<"\tThe last random value, generated by the linear congruential engine 'g1' (with respect to the operator '<<') is "<<g1<<"."<<endl<<endl;
	cout.flush();

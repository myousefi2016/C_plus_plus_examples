/**********************************************************************************************
 * Examples in the C++ language (the test 'Example-051')
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), January 2017
 *
 * main.cpp - the source file, implementing the main function for the test 'Example-051'.
 **********************************************************************************************/
...
int main(void)
{
	...
	/* This is the example 'Example-051', where the if-construct is tested. */
    cout<<endl<<"\tThis is the example 'Example-051' in the C++ language"<<endl<<endl;
    cout.flush();
    ...
    /* If we arrive here, we can decide! */

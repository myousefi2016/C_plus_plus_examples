...
This basic example about the use of the C++ programming language validates explicitly the use of several constructs (like the <i>'if-then-else'</i>) and the automatic conversions of values, even if they have been exploited in other previous tests. These constructs are exploited for defining a very dummy application, which computed the total fare for admitting patients, needing medical attention, to a fictional hospital.<p>In particular, this test consists of the <i>'Example-053'</i> executable file, starting uniquely from the <i>'main.cpp'</i> C++ source file (in the <i><code>'src'</code></i> folder) without using other dependencies.<p>Several methods for building this test are provided, and their building infrastructure is saved in the following folders:<p><ul>

/**********************************************************************************************
 * Examples in the C++ language (the test 'Example-063')
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), March 2017
 *
 * main.cpp - the source file, implementing the main function for the test 'Example-063'.
 **********************************************************************************************/
...
int main(void)
{
	/* This is the example 'Example-063', where the 'tuple' containers are validated. */
    cout<<endl<<"\tThis is the example 'Example-063' in the C++ language"<<endl<<endl;
    cout.flush();
    ...
    {
    	cout<<"\tThe new map 'm0' contains "<<m0.size()<<" associations between a 'string' and an 'uint' value, enumerated in the forward direction:"<<endl<<endl;
    	for(auto it=m0.cbegin();it!=m0.cend();it++) { cout<<"\tThe string '"<<it->first<<"' is associated with the 'uint' value "<<it->second<<endl; }
    	cout<<endl;
    	cout.flush();
    }
    ...
    cout<<"\tThe maximum capacity of the map 'm1': "<<m1.max_size()<<endl;
    ...
    /* TASK #3 - Another method for creating a copy of a map. */
    cout<<"\tCreating the copy 'm2' of the existing map 'm1' ... ";
    auto m2=m1;
    cout<<"ok"<<endl;
    if(m2.empty()==true) cout<<"\tThe new map 'm2' contains no association between a 'string' and an 'uint' value"<<endl;
    else cout<<"\tThe new map 'm2' contains "<<m2.size()<<" associations between a 'string' and an 'uint' value"<<endl;
    ...
    cout<<"\tThe map 'm2' contains the following associations between a 'string' and an 'uint' value:"<<endl<<endl;
    for(auto it=m2.begin();it!=m2.end();it++) { cout<<"\tThe string '"<<it->first<<"' is associated with the 'uint' value "<<it->second<<endl; }
    cout<<endl;
    ...
    if(it!=m2.end())
    {
    	...
    	m2.erase(it);
    	cout<<"ok"<<endl;
    	cout<<"\tThe new map 'm2' contains the following "<<m2.size()<<" associations between a 'string' and an 'uint' value:"<<endl;
    	for(auto it=m2.rbegin();it!=m2.rend();it++) { cout<<"\tThe string '"<<it->first<<"' is associated with the 'uint' value "<<it->second<<endl; }
		cout<<endl;
    }
    else cout<<"\tThe map 'm2' contains no association, involving the string 'Two'"<<endl;
    if(m1==m2) cout<<"\tThe maps 'm1' and 'm2' contain exactly the same associations between a 'string' and an 'uint' value (with respect to the '==' operator)"<<endl;
    else cout<<"\tThe maps 'm1' and 'm2' do not contain exactly the same associations between a 'string' and an 'uint' value (with respect to the '==' operator)"<<endl;
    if(m1!=m2) cout<<"\tThe maps 'm1' and 'm2' do not contain exactly the same associations between a 'string' and an 'uint' value (with respect to the '!=' operator)"<<endl;
    else cout<<"\tThe maps 'm1' and 'm2' contain exactly the same associations between a 'string' and an 'uint' value (with respect to the '!=' operator)"<<endl;
    cout<<endl;
    
    /* TASK #4 - Creating a new map 'm3' for storing the swapping operation. */
    ...
    cout<<"\tAllocating a new map 'm4' for storing associations between a 'string' and an 'uint' value by using the custom function 'compareStrings()' for sorting correctly the keys ... ";
    ...
    else cout<<"\tThe new map 'm4' contains "<<m4->size()<<" associations between a 'string' and an 'uint' value"<<endl;
    ...
    cout<<"ok"<<endl<<"\tThe associations between a 'string' and an 'uint' value in the new allocated array are the following:"<<endl<<endl;
    for(int i=0;i<6;i++) { cout<<"\tThe string '"<<p[i].first<<"' is associated with the 'uint' value "<<p[i].second<<endl; }
    cout<<endl;
    ...
    cout<<"ok"<<endl<<endl;
 	...
 	cout<<"\tCreating an empty map 'm5' by using the custom struct for sorting the keys ... ";

...
int main(void)
{
	...
	if (a2 != a1) cout << "\tThe arrays 'a1' and 'a2' do not contain the same 'int' values position by position (with respect to the '!=' operator)." << endl;
	else cout<<"\tThe arrays 'a1' and 'a2' contain the same 'int' values position by position (with respect to the '!=' operator)."<<endl;
	cout.flush();
	...
	cout<<"\tThe 'int' values in the array 'a2' are:";

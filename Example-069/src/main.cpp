...
int main(void)
{
    ...
    if(a0.size()==0) { cout<<"none"<<endl; }
 	...
 	cout<<"ok"<<endl;
 	cout<<"\tThe maximum capacity of the array 'a1': "<<a1.max_size()<<endl;
 	...
 	array<int,3> a2=a1;
 	cout<<"ok"<<endl;
 	cout<<"\tThe first 'int' value in the array 'a1': "<<a1.front()<<endl;
 	cout<<"\tThe 'int' value of the array 'a1' in position #1: "<<a1.at(1)<<endl;
 	cout<<"\tThe last 'int' value in the array 'a1': "<<a1.back()<<endl;
 	if(a2==a1) cout<<"\tThe arrays 'a1' and 'a2' contain the same 'int' values position by position"<<endl<<endl;
 	else cout<<"\tThe arrays 'a1' and 'a2' do not contain the same 'int' values position by position"<<endl<<endl;
 	cout.flush();
	...
	cout<<endl;
	if(a2<a3) cout<<"\tThe array 'a2' is 'strictly less than' the array 'a3'"<<endl;
 	else cout<<"\tThe array 'a2' is not 'strictly less than' the array 'a3'"<<endl;
	...
	for(auto it=a3.cbegin();it!=a3.cend();it++) cout<<(*it)<<" ";
	cout<<endl;
	if(a2<a3) cout<<"\tThe array 'a2' is 'strictly less than' the array 'a3'"<<endl<<endl;
 	else cout<<"\tThe array 'a2' is not 'strictly less than' the array 'a3'"<<endl<<endl;
 	cout<<"\tThe 'int' value in the location #0 of the array 'a2' (seen as a multidimensional 'tuple'): ";
 	tuple_element<0,decltype(a3)>::type a=get<0>(a2);
 	cout<<a<<endl;
 	cout<<"\tThe 'int' value in the location #1 of the array 'a2' (seen as a multidimensional 'tuple'): ";
 	a=get<1>(a2);
 	cout<<a<<endl;
 	cout<<"\tThe 'int' value in the location #2 of the array 'a2' (seen as a multidimensional 'tuple'): ";
 	a=get<2>(a2);
 	cout<<a<<endl<<endl;
 	cout.flush();
    return EXIT_SUCCESS;

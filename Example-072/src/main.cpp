...
int main(void)
{
    ...
    cout<<"\tCreating an empty list 'l0' of 'int' values ... ";
 	...
 	list<int> l0;
 	cout<<"ok"<<endl;
 	cout<<"\t#values in the list 'l0': "<<l0.size()<<endl;
    if(l0.empty()==true) cout<<"\tThe list 'l0' is empty"<<endl;
 	else cout<<"\tThe list 'l0' is not empty"<<endl;
 	cout.flush();
    cout<<"\tCreating 5 new locations in the list 'l0', storing the default 'int' value ... ";
 	l0.assign(5,100);
 	cout<<"ok"<<endl;
 	if(l0.empty()==true) cout<<"\tThe list 'l0' is empty"<<endl;
 	else cout<<"\tThe list 'l0' is not empty"<<endl;
 	cout<<"\t#values in the list 'l0': "<<l0.size()<<endl;
 	cout<<"\tThe 'int' values in the list 'l0':";
	...
	cout.flush();
	l0.resize(3);
	cout<<"ok"<<endl<<"\t#values in the list 'l0': "<<l0.size()<<endl;
 	cout<<"\tThe 'int' values in the list 'l0':";
 	for(auto it=l0.cbegin();it!=l0.cend();++it) cout<<" "<<(*it);
 	cout<<endl<<endl;
 	cout.flush();
 	...
 	list<int> l1 (4,37);
 	cout<<"ok"<<endl;
 	cout<<"\t#values in the list 'l1': "<<l1.size()<<endl;
 	cout<<"\tThe 'int' values in the list 'l1':";
	...
	cout.flush();
 	...
 	/* TASK #3 - creating a new list as the copy of another. */
 	cout<<"\tCreating a list 'l2' as the copy of the list 'l1' ... ";
 	list<int> l2 (l1.begin(),l1.end());
 	cout<<"ok"<<endl;
 	cout<<"\t#values in the list 'l2': "<<l2.size()<<endl;
 	cout<<"\tThe 'int' values in the list 'l2':";
 	...
 	if(l1==l2) cout<<"\tThe lists 'l1' and 'l2' coincide"<<endl<<endl;
 	else cout<<"\tThe lists 'l1' and 'l2' do not coincide"<<endl<<endl;
 	cout.flush();
 	
 	/* TASK #4 - creating a new list as the copy of another. */
 	cout<<"\tCreating a list 'l3' as the copy of the list 'l2' ... ";
 	list<int> l3(l2);
 	cout<<"ok"<<endl;
 	cout<<"\t#values in the list 'l3': "<<l3.size()<<endl;
 	cout<<"\tThe 'int' values in the list 'l3':";
 	...
 	if(l2!=l3) cout<<"\tThe lists 'l2' and 'l3' do not coincide"<<endl<<endl;
 	else cout<<"\tThe lists 'l2' and 'l3' coincide"<<endl<<endl;
 	cout.flush();
 	...
 	cout<<endl;
 	cout<<"\tThe 'int' values in the list 'l4' (in the reverse direction):";
 	for(auto it=l4.crbegin();it!=l4.crend();it++) cout<<" "<<(*it);
 	cout<<endl;
 	cout<<"\tThe first 'int' value of the list 'l4' (in the forward direction): "<<l4.front()<<endl;
 	cout<<"\tRemoving the first 'int' value of the list 'l4' (in the forward direction) ... ";
 	l4.pop_front();
 	cout<<"ok"<<endl;
 	cout<<"\tThe last 'int' value of the list 'l4' (in the forward direction): "<<l4.back()<<endl;
 	...
 	cout<<"\tThe maximum size of the list 'l4': "<<l4.max_size()<<endl;
    ...
    cout<<"\tAllocating a new list 'l5' ... ";
 	...
 	cout<<"ok"<<endl;
 	cout<<"\t#values in the list 'l5': "<<l5->size()<<endl;
    cout<<"\tThe 'int' values in the list 'l5' (in the forward direction):";
 	for(auto it=l5->begin();it!=l5->end();++it) cout<<" "<<(*it);
 	cout<<endl;
 	l4.sort();
 	l5->sort();
 	cout<<"\tMerging the lists 'l4' and 'l5', and saving the result in the list 'l4' (the list 'l5' becomes 'empty') ... ";
 	l4.merge(*l5);
 	cout<<"ok"<<endl;
 	cout<<"\t#values in the list 'l4': "<<l4.size()<<endl;
    cout<<"\tThe 'int' values in the list 'l4' (in the forward direction):";
 	for(auto it=l4.begin();it!=l4.end();++it) cout<<" "<<(*it);
 	cout<<endl;
 	if(l5->empty()) cout<<"\tThe list 'l5' is empty"<<endl;
 	else
 	{
 		cout<<"\t#values in the list 'l5': "<<l5->size()<<endl;
    	cout<<"\tThe 'int' values in the list 'l5' (in the forward direction):";
 	...
 	/* If we arrive here, we swap the content of the lists 'l4' and 'l5'. */
 	cout<<endl<<"\tSwapping the content of the list 'l4' and 'l5' ... ";
 	l5->swap(l4);
 	cout<<"ok"<<endl;
 	if(l4.empty()) cout<<"\tThe list 'l4' is empty"<<endl;
 	else
 	{
 		cout<<"\t#values in the list 'l4': "<<l4.size()<<endl;
    	cout<<"\tThe 'int' values in the list 'l4' (in the forward direction):";
 	...
 	else
 	{
    	...
    	cout<<"\tThe 'int' values in the list 'l5' (in the forward direction):";
 		...
 		l5->erase(it);
 		cout<<"ok"<<endl<<"\tThe 'int' values in the list 'l5' (in the forward direction):";
 		for(auto it=l5->begin();it!=l5->end();++it) cout<<" "<<(*it);
 		cout<<endl;
 		it=l5->begin();
 		advance(it,3);
 		...
 		for(auto it=l5->begin();it!=l5->end();++it) cout<<" "<<(*it);
 		cout<<endl;
 		cout<<"\tRemoving the odd 'int' values from the list 'l5' ... ";
 		l5->remove_if(isOdd);
 		cout<<"ok"<<endl<<"\tThe 'int' values in the list 'l5' (in the forward direction):";
 		for(auto it=l5->begin();it!=l5->end();++it) cout<<" "<<(*it);
 		cout<<endl;
    	...
    	cout<<"\tThe 'int' values in the list 'l4' (in the forward direction):";
 		...
 		cout<<endl;
 		cout<<"\t#values in the list 'l5': "<<l5->size()<<endl;
 		cout<<"\tRemoving the even 'int' values from the list 'l5' ... ";
 		l5->remove_if(EvenStruct());
 		cout<<"ok"<<endl;
 		if(l5->empty()) cout<<"\tThe list 'l5' is empty"<<endl<<endl;
 		else
 		{
 			cout<<"\t#values in the list 'l5': "<<l5->size()<<endl;
 			cout<<"\tThe 'int' values in the list 'l5' (in the forward direction):";
 	...
 	/* TASK #8 - transferring the 'int' values between two lists. */
 	...
 	cout<<"ok"<<endl;
	cout<<"\t#values in the list 'l3': "<<l3.size()<<endl;
 	cout<<"\tThe 'int' values in the list 'l3' (in the forward direction):";
 	...
 	cout<<"ok"<<endl<<"\tThe 'int' values in the list 'l3' (in the forward direction):";
 	for(auto it=l3.begin();it!=l3.end();++it) cout<<" "<<(*it);
 	cout<<endl;
 	cout<<"\t#values in the list 'l4': "<<l4.size()<<endl;
 	cout<<"\tThe 'int' values in the list 'l4' (in the forward direction):";
    ...
    /* TASK #10 - deallocating all lists */

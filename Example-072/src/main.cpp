/**************************************************************************************************
 * Examples in the C++ language (the 'Example-072' Test).
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), June 2017
 *
 * main.cpp - the source file, implementing the main function for the 'Example-072' Test.
 **************************************************************************************************/
...
/// The main function for the <i>'Example-072'</i> Test.
int main(void)
{
	/* This is the 'Example-072' Test, where the 'list' containers are validated. */
    cout<<endl<<"\tThis is the 'Example-072' Test in the C++ language."<<endl<<endl;
	cout.flush();
    ...
    cout<<"\tThe 'int' values in the list 'l5' (in the forward direction) are:";
 	for(auto it=l5->begin();it!=l5->end();++it) cout<<" "<<(*it);
 	cout<<"."<<endl<<"\tThe 'int' values in the list 'l4':"<<endl<<endl;
 	if(l4<(*l5)) cout<<"\t\t-) are 'strictly less than' the 'int' values in the list 'l5' (with respect to the '<' operator);"<<endl;
 	else cout<<"\t\t-) are not 'strictly less than' the 'int' values in the list 'l5' (with respect to the '<' operator);"<<endl;
 	if(l4<=(*l5)) cout<<"\t\t-) may be either 'strictly less than', or 'the same as' the 'int' values in the list 'l5' (with respect to the '<=' operator);"<<endl;
 	else cout<<"\t\t-) are not both 'strictly less than', and 'the same as' the 'int' values in the list 'l5' (with respect to the '<=' operator);"<<endl;
 	if(l4>(*l5)) cout<<"\t\t-) are 'strictly greater than' the 'int' values in the list 'l5' (with respect to the '>' operator);"<<endl;
 	else cout<<"\t\t-) are not 'strictly greater than' the 'int' values in the list 'l5' (with respect to the '>' operator);"<<endl;
 	if(l4>=(*l5)) cout<<"\t\t-) may be either 'strictly greater than', or 'the same as' the 'int' values in the list 'l5' (with respect to the '>=' operator)."<<endl<<endl;
 	else cout<<"\t\t-) are not both 'strictly greater than', and 'the same as' the 'int' values in the list 'l5' (with respect to the '>=' operator)."<<endl<<endl;
	cout<<"\tSwapping the content of the lists 'l4' and 'l5' ... ";
 	l5->swap(l4);
 	cout<<"ok"<<endl;
	cout<<"\t#values in the list 'l4' is "<<l4.size()<<"."<<endl;
    cout<<"\tThe 'int' values in the list 'l4' (in the forward direction) are:";
    ...
    cout<<"\tThe 'int' values in the list 'l4' (in the forward direction) are:";
 	for(auto it=l4.begin();it!=l4.end();++it) cout<<" "<<(*it);
	cout<<"."<<endl<<"\t#values in the list 'l5' is "<<l5->size()<<"."<<endl;
	cout<<"\tThe 'int' values in the list 'l5' (in the forward direction) are:";
	...
	/* TASK #9 - manipulating the 'int' values in the list 'l4'. */
 	cout<<"\t#values in the list 'l4' is "<<l4.size()<<"."<<endl;
    cout<<"\tThe 'int' values in the list 'l4' (in the forward direction) are:";
 	for(auto it=l4.begin();it!=l4.end();++it) cout<<" "<<(*it);
 	cout<<"."<<endl;
	it=l4.begin();
 	advance(it,2);
	cout<<"\tRemoving the 'int' value "<<(*it)<<" in position 2 from the list 'l4' ... ";
 	l4.erase(it);
 	...
 	advance(it1,5);
 	cout<<"\tRemoving the 'int' values of the list 'l4' from position 3 to 4 ... ";
 	l4.erase(it,it1);
 	cout<<"ok"<<endl<<"\t#values in the list 'l4' is "<<l4.size()<<"."<<endl;
	cout<<"\tThe 'int' values in the list 'l4' (in the forward direction) are:";
 	for(auto it=l4.begin();it!=l4.end();++it) cout<<" "<<(*it);
 	cout<<"."<<endl;
 	cout<<"\tRemoving all occurrences of the 'int' value 20 from the list 'l4' ... ";
 	l4.remove(20);
 	cout<<"ok"<<endl<<"\t#values in the list 'l4' is "<<l4.size()<<"."<<endl;
	cout<<"\tThe 'int' values in the list 'l4' (in the forward direction) are:";
 	for(auto it=l4.begin();it!=l4.end();++it) cout<<" "<<(*it);
 	cout<<"."<<endl;
 	cout<<"\tRemoving the odd 'int' values from the list 'l4' (see the 'isOdd()' custom function) ... ";
 	l4.remove_if(isOdd);
 	cout<<"ok"<<endl<<"\t#values in the list 'l4' is "<<l4.size()<<"."<<endl;
 	cout<<"\tThe 'int' values in the list 'l4' (in the forward direction) are:";
 	for(auto it=l4.begin();it!=l4.end();++it) cout<<" "<<(*it);
 	cout<<"."<<endl;
	cout<<"\tAssigning the remaining 'int' values of the list 'l4' also to the list 'l5' ... ";
 	l5->assign(l4.begin(),l4.end());
	cout<<"ok"<<endl<<"\t#values in the list 'l5' is "<<l5->size()<<"."<<endl;
	cout<<"\tThe 'int' values in the list 'l5' (in the forward direction) are:";
	for(auto it=l5->begin();it!=l5->end();++it) cout<<" "<<(*it);
 	cout<<"."<<endl;
 	cout<<"\tRemoving the even 'int' values from the list 'l4' (see the 'EvenStruct' custom struct) ... ";
 	l4.remove_if(EvenStruct());
 	cout<<"ok"<<endl;
	cout<<"\t#values in the list 'l4' is "<<l4.size()<<"."<<endl;
	cout<<"\tThe 'int' values in the list 'l4' (in the forward direction) are:";
	...
	/* TASK #10 - transferring the 'int' values between two lists. */
 	cout<<"\tUpdating the content of the existing lists 'l3' and 'l5' ... ";
 	l3.clear();
 	for (int i=1; i<=4; ++i) l3.emplace_back(i);
 	for (int i=1; i<=3; ++i) l5->emplace_front(i*10);
 	l5->emplace(l5->begin(),50);
 	cout<<"ok"<<endl;
    ...
    if(l5->empty()==true) cout<<" none";
 	...
 	cout<<"."<<endl;
	cout<<"\tTransferring several 'int' values between the lists 'l3' and 'l5' ... ";
 	it=l3.begin();
 	++it;
 	l3.splice(it,*l5);
 	l5->splice(l5->begin(),l3,it);
 	it=l3.begin();
 	std::advance(it,3);
    ...
    cout<<"\tDeallocating all lists in this test ... ";
    l0.clear();
    l1.clear();
    l2.clear();
    l3.clear();

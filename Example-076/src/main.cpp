...
int main(void)
{
    ...
    cout<<"\tCreating an empty set 's0' of 'long' values ... ";
 	...
 	set<long> s0;
 	cout<<"ok"<<endl;
 	cout<<"\t#values in the set 's0': "<<s0.size()<<endl;
    if(s0.empty()==true) cout<<"\tThe set 's0' is empty"<<endl<<endl;
 	...
 	long ls[]= {50,30,20,10,40};
  	...
  	set<long> s1 (ls,ls+5);
  	cout<<"ok"<<endl;
  	cout<<"\t#values in the set 's1': "<<s1.size()<<endl;
    if(s1.empty()==true) cout<<"\tThe set 's1' is empty"<<endl;
 	else cout<<"\tThe set 's1' is not empty"<<endl;
  	cout<<"\tThe maximum capacity of the set 's1': "<<s1.max_size()<<endl;
    ...
    if(s0.empty()==true) cout<<"\tThe set 's0' is empty"<<endl;
 	...
 	cout<<"\t#values in the set 's1': "<<s1.size()<<endl;
    if(s1.empty()==true) cout<<"\tThe set 's1' is empty"<<endl<<endl;
 	else cout<<"\tThe set 's1' is not empty"<<endl<<endl;
 	cout.flush();
  	...
  	cout<<"ok"<<endl;
  	cout<<"\t#values in the set 's2': "<<s2.size()<<endl;
    if(s2.empty()==true) cout<<"\tThe set 's2' is empty"<<endl;
 	...
 	cout<<"\tEnumerating the 'long' values in the set 's2' (in the forward direction): ";
  	...
  	cout<<"ok"<<endl;
  	cout<<"\t#values in the set 's3': "<<s3.size()<<endl;
    if(s3.empty()==true) cout<<"\tThe set 's3' is empty"<<endl;
 	else cout<<"\tThe set 's3' is not empty"<<endl;
 	if(s2==s3) cout<<"\tThe 'long' values in the sets 's2' and 's3' coincide (position by position)"<<endl;
 	else cout<<"\tThe 'long' values in the sets 's2' and 's3' coincide (position by position)"<<endl;
 	...
 	cout<<"\tCreating a new set 's4' by using a custom sorting function ... ";
 	set<long,bool(*)(const long&,const long&)> s4(compare_long_values);
 	cout<<"ok"<<endl;
 	cout<<"\t#values in the set 's4': "<<s4.size()<<endl;
    ...
    if(s4.empty()==true) cout<<"\tThe set 's4' is empty"<<endl;
 	...
 	else
 	{
 		...
 		cout<<"\t#values in the set 's4': "<<s4.size()<<endl;
 		if(s4.find(10)==s4.end()) cout<<"\tThe 'long' value 10 does not belong to the set 's4'"<<endl;
 		else cout<<"\tThe 'long' value 10 belongs to the set 's4'"<<endl;
 	}
 	...
 	cout<<"\tEnumerating the 'long' values in the set 's4' (in the forward direction): ";
  	...
  	cout<<"\tCreating a new set 's5' by using a custom (sorting) struct ... ";
 	...
 	cout<<"ok"<<endl<<"\tThe 'long' values in the new allocated array:";

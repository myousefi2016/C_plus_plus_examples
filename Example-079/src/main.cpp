/**********************************************************************************************
 * Examples in the C++ language (the test 'Example-079')
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), January 2017
 *
 * main.cpp - the source file, implementing the main function for the test 'Example-079'.
 **********************************************************************************************/
...
int main(void)
{
	/* This is the example 'Example-079', where a generic C++11 random device is validated. */
	cout<<endl<<"\tThis is the example 'Example-079' in the C++ language"<<endl<<endl;
    cout.flush();
    ...
    else { cout<<" [ the current library implementation employs a real-random number generator, instead of a random number engine, instead of  ]"<<endl<<endl; }

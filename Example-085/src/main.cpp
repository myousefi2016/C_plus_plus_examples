/****************************************************************************************************************************
 * Examples in the C++ language (the 'Example-085' Test).
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), July 2017
 *
 * main.cpp - the source file, implementing the main function for the 'Example-085' Test.
 ****************************************************************************************************************************/
...
/// The main function for the <i>'Example-085'</i> Test.
int main(void)
{
	ParentClass *c0=nullptr;

	/* This is the 'Example-085' Test, where the constructs for exploiting the (simple) inheritance are validated. */
    cout<<endl<<"\tThis is the 'Example-085' Test in the C++ language."<<endl<<endl;
    cout.flush();

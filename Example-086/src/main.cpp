/****************************************************************************************************************************
 * Examples in the C++ language (the 'Example-086' Test).
 *
 * GitHub repository: http://github.com/davidcanino/C_plus_plus_examples
 *
 * Created by David Canino (canino.david@gmail.com), July 2017
 *
 * main.cpp - the source file, implementing the main function for the 'Example-086' Test.
 ****************************************************************************************************************************/
...
class ParentClass
{
	...
	/// This pure virtual member function performs a dummy operation, offered by the <i>'parent class'</i> in the <i>'(simple) inheritance'</i> mechanism.
	virtual void dummyOperation()=0;
...
class ChildClass : public ParentClass
{
	...
	/// This (not pure) virtual member function performs a dummy operation, offered by the <i>'child class'</i> in the <i>'(simple) inheritance'</i> mechanism.
	virtual inline void dummyOperation()
	{
		cout<<"\t\t-) running the (not pure) virtual 'dummyOperation()' member function in the 'ChildClass' class"<<endl;
		cout.flush();
	}
};

/// The main function for the <i>'Example-086'</i> Test.
int main(void)
{
	ParentClass *c0=nullptr;

	/* This is the 'Example-086' Test, where the constructs for exploiting the (simple) inheritance are validated. */
    cout<<endl<<"\tThis is the 'Example-086' Test in the C++ language."<<endl<<endl;
    cout.flush();
